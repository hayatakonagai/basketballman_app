...
<div class="form-group row">
    ...
    <div class="col-md-7">
        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror samazon-login-input" name="name" value="{{ old('name', !empty($team->name) ?  $team->name : '') }}" required autocomplete="name" autofocus placeholder="アルバルク東京">
...
<div class="form-group row">
    <label for="image" class="col-md-5 col-form-label text-md-left">チーム写真<span class="ml-1 samazon-nullable-input-label"><span class="samazon-nullable-input-label-text">任意</span></span></label>

    <div class="col-md-7">
        <input id="image" type="file" class="form-control-file @error('image') is-invalid @enderror samazon-login-input" name="image" value="{{ !empty($team->image) ?  $team->image : old('image')}}">
        @error('image')
